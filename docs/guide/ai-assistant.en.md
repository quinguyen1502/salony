...
<figure markdown>
![AI summary card on Reports](../images/en/light/reports-ai.png){ loading=lazy }
...
<figure markdown>
![Hold to talk on the invoice form](../images/en/light/bills-form-voice.png){ loading=lazy }
