...
<figure markdown>
![Add staff](../images/en/light/staff-add-sheet.png){ loading=lazy }
...
<figure markdown>
![Virtual staff profile](../images/en/light/staff-virtual.png){ loading=lazy }
...
<figure markdown>
![Staff detail](../images/en/light/staff-detail.png){ loading=lazy }
