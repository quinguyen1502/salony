...
<figure markdown>
![Thẻ tóm tắt AI trên màn Báo cáo](../images/vi/light/reports-ai.png){ loading=lazy }
...
<figure markdown>
![Nút Giữ để nói trên form hóa đơn](../images/vi/light/bills-form-voice.png){ loading=lazy }
